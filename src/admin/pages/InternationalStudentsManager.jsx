...
//   // Static child pages for fallback
...
//           <Link to="/admin/pages/international-students" className="hover:text-secondary">International Students</Link>
//           <ChevronRight size={14} />
//           <span className="text-gray-700">Manage Pages</span>
//         </div>
...
//             </div>
//             <div>
//               <h1 className="text-2xl font-bold text-primary">International Students Pages</h1>
//               <p className="text-gray-500 text-sm">Manage all International Students pages</p>
//             </div>
//           </div>
...
//       {/* Child Pages List */}
//       <div>
//         <h2 className="text-lg font-semibold text-primary mb-3">Child Pages ({pages.length})</h2>
...
//         <h3 className="font-medium text-blue-800 mb-2">Managing International Students Pages</h3>
              ...
              <tbody className="divide-y divide-gray-100">
                {pages.map((page, index) => (
                  <tr key={page.pageId} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-4 py-3">
                      <span className={`inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium ${
                        page.isActive !== false ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-600'
                      }`}>
                        {page.isActive !== false
